...
/** Define reactive data breadcrumbs for storing breadcrumb navigation info */
const breadcrumbs = ref<RouteLocationMatched[]>([])

/** Get breadcrumb navigation info */
...
// Listen for route changes and update breadcrumb navigation info
