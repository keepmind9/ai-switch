...
export const createRoute = (data: Partial<Route> & { key: string; provider: string }) => client.post('/admin/routes', data)
export const updateRoute = (key: string, data: Partial<Route>) => client.put(`/admin/routes/${key}`, data)
